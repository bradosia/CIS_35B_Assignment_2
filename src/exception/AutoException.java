...
public class AutoException extends Exception {
	...
	private exception.Log log;

	public void init() {
		errorNumber = 0;
		errorMessage = "";

		log = new exception.Log();
	...
	public AutoException(int errorNumber_) {
		...
		String printMessage = "Error #" + this.errorNumber + ": " + this.errorMessage;
	...
	public AutoException(int errorNumber_, boolean warning) {
		...
		String printMessage = "Warning #" + this.errorNumber + ": " + this.errorMessage;
		log.info(printMessage);
	}
